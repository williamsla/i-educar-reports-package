    ...
    protected function query()
    {
        ...
        return <<<SQL
            SELECT
                ...
                SUM(CASE WHEN eja10 AND matricula_ativa AND entrou_antes_inicio AND saiu_depois_inicio THEN 1 ELSE 0 END) AS eja_10,
                SUM(CASE WHEN eja11 AND matricula_ativa AND entrou_antes_inicio AND saiu_depois_inicio THEN 1 ELSE 0 END) AS eja_11,
